...
// Untuk Pendaftaran
$router->group(['prefix' => 'daftar'], function () use ($router) {
	$router->get('/',  ['as'=>'index-daftar','uses' => 'DaftarController@index']);
    $router->post('/get-detail',  ['as'=>'detail','uses' => 'DaftarController@show']);
    $router->post('/update',  ['as'=>'update-daftar','uses' => 'DaftarController@update']);
    $router->post('/store',  ['as'=>'store-daftar','uses' => 'DaftarController@store']);
    $router->get('/create',  ['as'=>'create-daftar','uses' => 'DaftarController@create']);
    $router->post('/update-password',  ['as'=>'update-password-user','uses' => 'DaftarController@updatePassword']);
    $router->post('/delete',  ['as'=>'delete-user','uses' => 'DaftarController@delete']);
});
...
$router->group(['prefix' => 'siswa'], function () use ($router) {
	...
	$router->get('/get-siswa',  ['as'=>'get-siswa','uses' => 'SiswaController@getUserSiswa']);
