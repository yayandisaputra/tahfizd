...
// Pendaftaran
Breadcrumbs::for('index-daftar', function ($trail) {
    $trail->push('Pendaftaran', route('index-daftar'));
});

Breadcrumbs::for('create-daftar', function ($trail) {
    $trail->parent('index-daftar');
    $trail->push('Tambah', route('index-daftar'));
});
