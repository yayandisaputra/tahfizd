...
class DaftarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        {
            $this->systemLog(false,'Mengakses halaman pendaftaran');
            return view('pendaftaran.index', ['active'=>'daftar']);
        }
        else
        {
            $this->systemLog(true,'Gagal Mengakses halaman pendaftaran');
            return view('error.unauthorized', ['active'=>'daftar']);
        }
    }
    ...
    {
        if($this->getUserPermission('create daftar'))
        {
            $this->systemLog(false,'Mengakses halaman create pendaftaran');
            return view('pendaftaran.store', ['active'=>'daftar']);
        }
        else
        {
            $this->systemLog(true,'Gagal Mengakses halaman create pendaftaran');
            return view('error.unauthorized', ['active'=>'daftar']);
        }
    }
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        if(!$user->save())
        {
            ...
            DB::rollBack();
            return redirect('daftar')->with('alert_error', 'Gagal Disimpan');
        }
        ...
        if($this->getUserPermission('create user'))
        {
            ...
            DB::commit();
            return redirect('daftar')->with('alert_success', 'Berhasil Disimpan');
        }
        else
        {
            $this->systemLog(true,'Gagal menyimpan user');
